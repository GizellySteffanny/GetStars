...
monsterImage.src = 'img/star.png';

// Objetos do jogo
const hero = {
	speed: 256 // movimento em pixels por segundos
};
const monster = {};
...
const reset = function(){
	...
	// Posiciona o mostro randonicamente na tela
...
const update = function(modifier){
	if (38 in keysDown){ // Pressionando seta pra cima
...
const render = function(){
	...
	ctx.fillText('Stars Captured: ' + monstersCaught, 32, 32);
};
